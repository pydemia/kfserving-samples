...
curl -k -sL https://github.com/jetstack/cert-manager/releases/download/${CERT_MANAGER_VERSION}/cert-manager.yaml -O && \
...
############################################
"
curl -k -sL https://istio.io/downloadIstio | ISTIO_VERSION=${ISTIO_VERSION} sh -
...
curl -k -sL https://raw.githubusercontent.com/knative/serving/master/third_party/istio-1.4.9/istio-knative-extras.yaml -O && \
...
curl -k -sL https://github.com/knative/serving/releases/download/${KNATIVE_VERSION}/serving-crds.yaml -O && \
    kubectl apply -f serving-crds.yaml
# 2. Install the core components of `Serving`
curl -k -sL https://github.com/knative/serving/releases/download/${KNATIVE_VERSION}/serving-core.yaml -O && \
    kubectl apply -f serving-core.yaml

sleep 30
# 3-1. Install the Knative Istio controller:
curl -k -sL https://github.com/knative/net-istio/releases/download/${KNATIVE_VERSION}/release.yaml -o serving-istio.yaml && \
    kubectl apply --filename serving-istio.yaml --request-timeout="3m"

curl -k -sL https://github.com/knative/net-istio/releases/download/${KNATIVE_VERSION}/net-istio.yaml -O && \
    kubectl apply --filename net-istio.yaml --request-timeout="3m"

# v0.13.0[NAME CHANGED]
# curl -k -sL https://github.com/knative/serving/releases/download/${KNATIVE_VERSION}/serving-istio.yaml -O && \
#     kubectl apply -f serving-istio.yaml

kubectl --namespace istio-system get service istio-ingressgateway
# # 4. Configure DNS: Magic DNS (`xip.io`)
# curl -k -sL https://github.com/knative/serving/releases/download/${KNATIVE_VERSION}/serving-default-domain.yaml -O && \
#     kubectl apply -f serving-default-domain.yaml

curl -k -sL https://github.com/knative/serving/releases/download/v0.14.0/serving-default-domain.yaml -O && \
...
curl -k -sL https://github.com/knative/serving/releases/download/${KNATIVE_VERSION}/serving-hpa.yaml -O && \
    kubectl apply -f serving-hpa.yaml
# TLS cert-manager
curl -k -sL https://github.com/knative/serving/releases/download/${KNATIVE_VERSION}/serving-cert-manager.yaml -O && \
...
wget https://github.com/knative/net-http01/releases/download/v0.14.0/release.yaml -O serving-http01.yaml && \
    kubectl apply --filename serving-http01.yaml
# TLS wildcard
curl -k -sL https://github.com/knative/serving/releases/download/${KNATIVE_VERSION}/serving-nscert.yaml -O && \
    kubectl apply -f serving-nscert.yaml

sleep 90
# 7. Eventing Components
curl -k -sL https://github.com/knative/eventing/releases/download/${KNATIVE_VERSION}/eventing-crds.yaml -O && \
    kubectl apply -f eventing-crds.yaml
curl -k -sL https://github.com/knative/eventing/releases/download/${KNATIVE_VERSION}/eventing-core.yaml -O && \
...
curl -k -sL https://knative.dev/docs/eventing/samples/kafka/kafka_setup.sh -o kafka_setup_for_knative.sh && \
...
curl -k -sL https://github.com/knative/eventing/releases/download/${KNATIVE_VERSION}/channel-broker.yaml -O && \
...
curl -k -sL https://github.com/knative/eventing-contrib/releases/download/${KNATIVE_VERSION}/kafka-source.yaml -O && \
    kubectl apply -f kafka-source.yaml

# # GCP Pub/Sub Case
# curl -k -sL https://github.com/google/knative-gcp/releases/download/${KNATIVE_VERSION}/cloud-run-events.yaml -O && \
#     kubectl apply -f cloud-run-events.yaml
# curl -k -sL https://github.com/knative/eventing/releases/download/${KNATIVE_VERSION}/channel-broker.yaml -O && \
#     kubectl apply -f channel-broker.yaml

# # 8. Observability Plugins (FEATURE STATE: deprecated @ Knative v0.14)
curl -k -sL https://github.com/knative/serving/releases/download/${KNATIVE_VERSION}/monitoring-core.yaml -O && \
    kubectl apply -f monitoring-core.yaml
curl -k -sL https://github.com/knative/serving/releases/download/${KNATIVE_VERSION}/monitoring-metrics-prometheus.yaml -O && \
    kubectl apply -f monitoring-metrics-prometheus.yaml
curl -k -sL https://github.com/knative/serving/releases/download/${KNATIVE_VERSION}/monitoring-tracing-zipkin-in-mem.yaml -O && \
    kubectl apply -f monitoring-tracing-zipkin-in-mem.yaml
# curl -k -sL https://github.com/knative/serving/releases/download/${KNATIVE_VERSION}/monitoring-tracing-jaeger-in-mem.yaml -O && \
#     kubectl apply -f monitoring-tracing-jaeger-in-mem.yaml
curl -k -sL https://github.com/knative/serving/releases/download/${KNATIVE_VERSION}/monitoring-logs-elasticsearch.yaml O && \
    kubectl apply -f monitoring-logs-elasticsearch.yaml


# curl -k -sL https://raw.githubusercontent.com/jaegertracing/jaeger-operator/master/deploy/crds/jaegertracing.io_jaegers_crd.yaml -O && \
#     kubectl apply -f jaegertracing.io__jaegers_crd.yaml
# curl -k -sL https://raw.githubusercontent.com/jaegertracing/jaeger-operator/master/deploy/service_account.yaml -O && \
#     kubectl apply -f service_account.yaml
# curl -k -sL https://raw.githubusercontent.com/jaegertracing/jaeger-operator/master/deploy/role.yaml -O && \
#     kubectl apply -f role.yaml
# curl -k -sL https://raw.githubusercontent.com/jaegertracing/jaeger-operator/master/deploy/role_binding.yaml -O && \
#     kubectl apply -f role_binding.yaml
# curl -k -sL https://raw.githubusercontent.com/jaegertracing/jaeger-operator/master/deploy/operator.yaml -O && \
#     kubectl apply -f operator.yaml

# curl -k -sL https://github.com/knative/serving/releases/download/v0.13.0/monitoring-tracing-jaeger-in-mem.yaml -O && \
#     kubectl apply -f monitoring-tracing-jaeger-in-mem.yaml
...
curl -k -sL https://raw.githubusercontent.com/kubeflow/kfserving/master/install/${KFSERVING_VERSION}/kfserving.yaml \
