...
CLUSTER_NM="kfserving-riesling"
REGION="us-central1"
#ZONE="us-central1-a"
CLUSTER_VERSION="1.17.14-gke.1600"  # "1.17.12-gke.1504"
MASTER_IPV4_CIDR="172.31.11.32/28"
# CLUSTER_IPV4_CIDR="10.128.0.0/20"  # 10.128.10.0 ~10.128.20.255
...
NUM_NODES="3"  # The number of nodes to be created in each of the cluster's zones. default: 3
MIN_NODES="0"  # Minimum number of nodes in the node pool. Ignored unless `--enable-autoscaling` is also specified.
MAX_NODES="9" # Maximum number of nodes in the node pool. Ignored unless `--enable-autoscaling` is also specified.
MAX_NODES_PER_POOL="100"  # Defaults to 1000 nodes, but can be set as low as 100 nodes per pool on initial create.
MAX_PODS_PER_NODE="64"  # default=110, Must be used in conjunction with '--enable-ip-alias'.
NETWORK="yjkim-vpc"  # "default" or VPC
SUBNETWORK="yjkim-kube-subnet"
...
LABELS="cz_owner=youngju_kim,application=kfserving,istio=1-7-7,knative=0-20-0,cert-manager=1-1-0,kfserving=0-5-0-rc2"
