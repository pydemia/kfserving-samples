...
mkdir -p knative-serving && \
  ...
  curl -fsSL https://github.com/knative/net-istio/releases/download/v0.16.0/release.yaml -O && \
  curl -fsSL https://github.com/knative/net-certmanager/releases/download/v0.16.0/release.yaml -O && \
